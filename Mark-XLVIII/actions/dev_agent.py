...
PROJECTS_DIR     = Path.home() / "Desktop" / "RookiProjects"
MAX_FIX_ATTEMPTS = 5
...
def _get_model(model_name: str = "openrouter/free"):
    ...
    class _W:
        ...
        def generate_content(self, contents, **kw):
            ...
            return type('R', (), {'text': ask_llm(prompt, model=self._m, max_tokens=384)})()
    return _W(model_name)
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "rooki_project")
