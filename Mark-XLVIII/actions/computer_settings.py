...
def _detect_action(description: str) -> dict:
    ...
    system_prompt = f"""You are an intent detector for a computer control assistant.
...
- Return ONLY the JSON, no explanation, no markdown."""
    ...
    prompt = f'The user issued a command (possibly in any language): "{description}"'

    try:
        resp = ask_llm(prompt=prompt, system=system_prompt)
